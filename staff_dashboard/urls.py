...
urlpatterns = [
    ...
    path("admin-password-requests/", views.admin_password_change_requests, name="admin_password_change_requests"),
    path(
        "admin-password-requests/<str:token>/",
        views.admin_password_change_request_detail,
        name="admin_password_change_request_detail",
    ),
